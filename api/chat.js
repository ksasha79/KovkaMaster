  ...
  try {
    ...
    const result = await ai.models.generateContent({ 
      ...
      config: {
        ...
        КОНТАКТЫ:
        - Основной офис: +7 (959) 187-89-49
        - Менеджер отдела продаж: +7 (992) 059-52-53
        ...
        ОБЯЗАТЕЛЬНО: Если клиент спрашивает цену или хочет заказать — направляйте его к форме "Вызвать замерщика" на сайте или предложите позвонить менеджеру по номеру +7 (992) 059-52-53 или в офис +7 (959) 187-89-49.`,
        temperature: 0.7,
      },
    });
