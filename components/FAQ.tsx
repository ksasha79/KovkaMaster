...
const faqs = [
  ...
  {
    question: "Устоит ли забор из сетки рабицы при сильных ветрах?",
    answer: "Да, это самый 'прозрачный' для ветра забор. Сетка рабица не имеет парусности, поэтому столбы не расшатываются даже на открытых степных участках Лискинского или Семилукского районов. Для надежности мы используем оцинкованную проволоку, которая не ржавеет после первой зимы."
  },
  {
