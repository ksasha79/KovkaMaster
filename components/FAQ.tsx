...
const faqs = [
  {
    ...
    answer: "Выезд мастера в пределах Ростовской области, а также в крупные города ДНР и ЛНР (Донецк, Макеевка, Луганск) при заключении договора осуществляется бесплатно. В остальных случаях стоимость обсуждается индивидуально."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы предоставляем официальную гарантию 5 лет на все сварные соединения и 2 года на лакокрасочное покрытие (при условии использования наших материалов)."
  },
  {
