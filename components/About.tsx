          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-xl text-gray-400 leading-relaxed font-light">
                ООО «Евро-Заборы» — это современные производственные мощности. Мы обеспечиваем замкнутый цикл: от проектирования и сварки до покраски и монтажа в Ростове, ЛНР, ДНР и Черноземье.
              </p>
            </div>
