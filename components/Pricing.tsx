...
const plans = [
  ...
  },
  {
    ...
    price: 'от 5 500 ₽',
    features: [
      'Индивидуальный дизайн ИИ',
      'Двустороннее окрашивание',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-gray-600 max-w-2xl mx-auto">
            Финальная стоимость рассчитывается за погонный метр и включает в себя производство, доставку и установку «под ключ».
          </p>
        </div>
        ...
        <div className="mt-16 p-6 bg-metal-800/5 rounded-2xl border border-dashed border-gray-300 text-center">
          <p className="text-sm text-gray-500">
            * Указанные цены являются ориентировочными. Точная смета составляется после замера и зависит от особенностей грунта и рельефа участка.
          </p>
        </div>
      </div>
    </section>
