...
const plans = [
  {
    name: 'Эконом',
    price: 'от 45 000 ₽',
    features: ['Профильная труба', 'Профнастил (С8/С20)', 'Базовая сварка', 'Грунт-эмаль 3-в-1', 'Монтаж за 1 день'],
    popular: false
  },
  {
    name: 'Стандарт',
    price: 'от 85 000 ₽',
    features: ['Элементы холодной ковки', 'Усиленный каркас', 'Полимерная покраска', 'Замок и фурнитура', 'Выезд мастера-дизайнера'],
    popular: true
  },
  {
    name: 'Премиум',
    price: 'от 150 000 ₽',
    features: ['Художественная горячая ковка', 'Индивидуальный эскиз ИИ', 'Патинирование (золото/медь)', 'Автоматика в комплекте', 'Гарантия 10 лет'],
    popular: false
  }
];
