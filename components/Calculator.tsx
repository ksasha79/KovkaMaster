...
const FENCE_TYPES: FenceType[] = [
  { id: 'prof-sheet', name: 'Забор из проф листа', price: 3500, icon: '📄', desc: 'Сплошное ограждение' },
  { id: 'picket-3d', name: 'Забор из 3Д штакета', price: 5500, icon: '📏', desc: 'Металлический штакетник' },
